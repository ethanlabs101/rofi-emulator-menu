...
BG_DIR="$THEME_DIR/retro-fi-backgrounds"
ACTIVE_BG="$THEME_DIR/retro-fi.png"

RASI_FILE="$REAL_HOME/.config/rofi/game-theme/retro-fi.rasi"
...
echo "                                                                   ░                           ";
echo "                       ┌───────────────────────────────────────────────┐                       ";
echo "                       │         RETRO-FI GAMING THEME EDITOR          │                       ";
echo "                       └───────────────────────────────────────────────┘                       ";
  echo "┌─────────────────────────────────────────────────────┐ "
